...
export const services = [
  {
    ...
    duration: "45 min",
    price: "AED 380",
    description: "A private consultation, precision cut, and finishing ritual designed for boardrooms and evening engagements.",
  },
  {
    name: "Beard Architecture",
    duration: "30 min",
    price: "AED 220",
    description: "Sculpted lines, hot-towel finishing, and house oils for a composed, modern profile.",
  },
  {
    name: "Signature Colour",
    duration: "90 min",
    price: "AED 850",
    description: "Discreet colour work with European formulations — never obvious, always considered.",
  },
  {
    name: "Royal Facial",
    duration: "60 min",
    price: "AED 620",
    description: "A restorative facial for sun-exposed skin, prepared for Dubai’s climate and late evenings.",
  },
  {
    name: "Hair Spa Ritual",
    duration: "45 min",
    price: "AED 480",
    description: "Scalp therapy and nourishing treatments to restore density, shine, and quiet luxury.",
  },
  {
    name: "The Black Reserve",
    duration: "150 min",
    price: "AED 1,800",
    description: "A closed-door grooming suite: cut, beard, facial, and valet finishing. By appointment only.",
  },
] as const;
